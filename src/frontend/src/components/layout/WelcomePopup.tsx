...
export function WelcomePopup() {
	...
	const content = {
		vi: {
			...
			description:
				"Hiện tại trang web đang trong quá trình hoàn thiện để đem lại trải nghiệm tốt nhất, mọi người khi mua acc vui lòng liên hệ zalo hoặc telegram",
			features: [
		...
		en: {
			...
			description:
				"#1 Trusted Play Together account shop in Vietnam! We commit:",
			features: [
