...
var (
	ErrAuthSuspended  = errors.New("auth account is suspended")
	ErrAuthUnverified = errors.New("auth account is unverified")
	...
	ErrVerifyCodeInvalid = errors.New("verification code is invalid")

	ErrAuthNotFound = errors.New("auth account not found")
)
